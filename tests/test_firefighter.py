import unittest
from project.firefighter import Firefighter
from project.land_rep import TreePatch, RockPatch
from project.graph_forrest import GraphInfo
from project.initialiser import initialise_patches, initialise_neighbours, initialise_color_map
